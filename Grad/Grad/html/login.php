                                ...
                                <form class="mx-1 mx-md-4" action="" method="post">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <label class="form-label" id="nom" for="form3Example1c">Votre nom d'utilisateur</label>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <label class="form-label" id="password" for="form3Example4c">Mot de passe</label>
                                        </div>
                                    </div>
